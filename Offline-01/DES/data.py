...
# data[] is 64 bit. PI[] is also 64bits.
# For example, 58th bit in data (data[57]) will be the first bit of transposed_data (transposed_data[0]),
...
# Use CP_1 array.
# It means, 57th bit (key[56] will be the first bit of modified_key:
